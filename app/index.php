...
$host = '${DB_HOST}'; // แก้ไขให้ตรงกับค่าทีอยู่ใน Docker Compose หรือ .env
$user = '${admin}'; // แก้ไขให้ตรงกับค่าที่อยู่ใน Docker Compose หรือ .env
$db   = '${test02_db}'; // แก้ไขให้ตรงกับค่าที่อยู่ใน Docker Compose หรือ .env
